...
var ContextMenu = (props) => {
  ...
  const handleOpenChange = React36.useCallback(
    (open2) => {
      setOpen(open2);
...
var ContextMenuTrigger = React36.forwardRef(
  (props, forwardedRef) => {
    const { __scopeContextMenu, disabled = false, ...triggerProps } = props;
    const context = useContextMenuContext(TRIGGER_NAME, __scopeContextMenu);
    const menuScope = useMenuScope(__scopeContextMenu);
    const pointRef = React36.useRef({ x: 0, y: 0 });
    const virtualRef = React36.useRef({
      getBoundingClientRect: () => DOMRect.fromRect({ width: 0, height: 0, ...pointRef.current })
    });
    const longPressTimerRef = React36.useRef(0);
    const clearLongPress = React36.useCallback(
    ...
    React36.useEffect(() => clearLongPress, [clearLongPress]);
    React36.useEffect(() => void (disabled && clearLongPress()), [disabled, clearLongPress]);
...
var ContextMenuContent = React36.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuGroup = React36.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuLabel = React36.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuItem = React36.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuRadioGroup = React36.forwardRef((props, forwardedRef) => {
...
var ContextMenuItemIndicator = React36.forwardRef((props, forwardedRef) => {
...
var ContextMenuSeparator = React36.forwardRef((props, forwardedRef) => {
...
var ContextMenuArrow = React36.forwardRef(
  (props, forwardedRef) => {
